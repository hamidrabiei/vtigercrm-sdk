...
public class TestWSClient {
	...
	static String vtigerURL = "http://vtiger.localhost/develop/5.1.0/prasad";
	static String vtigerUSR = "admin";
	static String vtigerUSRKEY = "zr7JMy2ijWPKaeo";
	...
	public static boolean Test_doQuery(WSClient client) {
		JSONArray result = client.doQuery("SELECT * FROM Leads");
		if (result == null)
			return false;
